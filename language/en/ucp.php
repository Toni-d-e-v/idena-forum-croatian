...
$lang = array_merge($lang, array(
	...
	'PROFILE_INFO_NOTICE'		=> 'In the profile fields, remove the http://www.facebook.com/ from what you are entering, same with the other fields. The forum automatically adds the start URL in for you so you only need to add the end bits, your username etc.',
	...
	'UCP_WELCOME'					=> 'Welcome to the User Control Panel. From here you can monitor, view and update your profile, preferences, subscribed forums and topics. You can also send messages to other users (if permitted). To edit your username go to Profile / Edit account settings',
